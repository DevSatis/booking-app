        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              The 272 well-appointed rooms include 22 suites. 
              All units have attached bathroom with a power shower to 
              recharge you after a long and busy day. 
              Some units include a seating area for your convenience. 
              For your comfort, you will find slippers and free toiletries.
              Located 34 kms from Kempegowda International Airport, 
              the hotel has easy access to Bengaluru City Junction Railway Station, 
              Bus Station, and Kempegowda Metro Station.
              </p>
            </div>
            <div className="hotelDetailsPrice">
              <h1>Perfect for 9-night stay!</h1>
              <span>
                Located in the real heart of the Bangalore, this property has an excellent 
                location score is 9.8! 
              </span>
              <h2>
                <b>$250</b> (9-nights) 
              </h2>
